 ...
 * @version SVN : $Id: om_lettretype.class.php 4363 2018-11-19 16:41:21Z fmichon $
 */

if (file_exists("../gen/obj/om_lettretype.class.php")) {
    require_once "../gen/obj/om_lettretype.class.php";
} else {
    require_once PATH_OPENMAIRIE."gen/obj/om_lettretype.class.php";
}
...
class om_lettretype_core extends om_lettretype_gen {
    ...
    function verifieractif($id, $val) {
        ...
        if ($nbligne > 0) {
            $this->correct = false;
            $msg = $nbligne." ";
            $msg .= __("lettre(s) type existante(s) dans l'etat actif. Il ".
                      "n'est pas possible d'avoir plus d'une lettre type");
            $msg .= " \"".$val["id"]."\" ".__("active par collectivite.");
