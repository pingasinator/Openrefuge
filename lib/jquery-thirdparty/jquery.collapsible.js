/**
 * CHANGES
 * v.2.1.3.1 - NON OFFICIAL CHANGE - Add a test to verifiy if fieldset is not
 *             already binded with collapsible function if not when you have a
 *             fieldset on a page and you call a page with fieldsets in a tab
 *             in ajax the fieldsets already presents are not working anymore.
...
jQuery.fn.collapse = function(options) {
    ...
    return this.each(function() {
        var obj = jQuery(this);
        if (!obj.find("legend:first").hasClass('collapsible')) {
