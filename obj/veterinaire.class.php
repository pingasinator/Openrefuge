...
require_once "../gen/obj/veterinaire.class.php";

class veterinaire extends veterinaire_gen {
    ...
    function view_pdf_edition_etat() {
        ...
        'veterinaire', //objet de mon etat
        $this->f->getCollectivite(),
        $this->id
        );
        $this->expose_pdf_output(
        $pdfedition["pdf_output"],
        "formulaire_vétérinaire-".date('YmdHis').".pdf"
        );
    }
}
